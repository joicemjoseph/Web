...

{
 ...
 $old_password=$_POST['old_password']; //echo $old_password;
 $new_password=$_POST['new_password']; //echo $new_password;
 $retype_new_password=$_POST['retype_new_password']; //echo $retype_new_password;
...
{
$result_update=mysql_query("update user set password='$new_password' WHERE username='$username'");
$result_update_register=mysql_query("update register set password='$new_password' WHERE username='$username'");
}
else
{
 $result_failure=1;
...
<form name="msgform" id="msgform" action="change_password.php" method="POST"  onKeyUp="highlight(event)" onClick="highlight(event)" onSubmit= "return validate_password(this);">
<table border="0" width="100%" align="center">
<tr><td colspan="4" align="left" class="style7">Change Password>></td></tr>
<tr><td>&nbsp;</td><td align="center"><br /><br /><br />
<table border="0" class="style7" width="450" bgcolor="#f4f4f4">
<tr>
      <td width="170" align="right"><br /><br />
      Old Password* :</td>
      <td><br /><br /><input id="old_password" size="30" type="password" name="old_password"></td>
       </tr>
      <tr>
      <td width="170" align="right">

      New Password* :</td>
      <td><input id="new_password" size="30" type="password" name="new_password"></td>
      </tr>
      <tr>
      <td width="170" align="right">
      Retype New Password* :</td>
      <td><input id="retype_new_password" size="30" type="password" name="retype_new_password">
      </td> </tr>
...
<tr>
<td width="170" valign="top"></td><td><br />
...
echo "<script>document.location.href='change_password.php?username=$username'</script>";
}

if($result_failure==1)
{
 $username=$_POST['username'];
echo "<script>alert('Old Password* you have entered is WRONG ! Try again..');</script>";
echo "<script>document.location.href='change_password.php?username=$username'</script>";
}
?>
</body>
