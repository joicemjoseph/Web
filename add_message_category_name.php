...

{
 ...
 $query = mysql_query("SELECT count(*) FROM sms_category WHERE category='$category'");
...
else
{
 ...
 $result=mysql_query("insert into sms_category(category)
 values('$category')");
...
<form name="msgform" id="msgform" action="add_message_category_name.php" method="POST"  onKeyUp="highlight(event)" onClick="highlight(event)" onSubmit= "return validate_category(this);">
<table border="0" width="100%" align="center" class="style7">
<tr><td colspan="4" align="left">Add SMS Category>></td></tr>
<tr> <td>&nbsp;</td><td align="center">&nbsp;<br /> <br /><br /><br /><br />
<table border="0" class="style7" bgcolor="#f4f4f4"><tr><td>
<tr><td align="right">
<br /><br />View Existing Categories</td><td><br /><br />
	<?php
	...
	?>
			<select>
    <option value ="" selected="selected" >___view Category___</option>
    <?php
...
<tr>
      ...
      Add New SMS Category :</td>
      <td width="220"><br /><br /><input id="category" size="30" type="text" name="category"></td>
     </tr>
...
<td width="220"></td>
<td> <br />
<input type='submit' value='Create Category' name="Submit"> <br /><br />
</td>
</tr>
</td></tr></table>
</td><td>&nbsp;</td></tr>
...
echo "<script>alert('$category is already created by You!!! Choose another..');</script>";
echo "<script>document.location.href='add_message_category_name.php?username=$username'</script>";
}
...
if($result_created==1)
{
 $group_name=$_POST['category'];
 $username=$_POST['username'];
echo "<script>alert('Category $category Created Successfully!!  Please add SMS to this category');</script>";
