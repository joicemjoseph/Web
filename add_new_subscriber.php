...
$mobile_no=$_GET['mobile_no']; //echo $mobile_no;
...
$query = mysql_query("SELECT count(*) FROM subscriber WHERE mobile_no='$mobile_no' AND group_name='$group_name'
 AND username='$username'");
$count = mysql_fetch_array($query);

if($count[0]>0)
{
$mob_exists_in_groupname=1;
}
else
{
  $result=mysql_query("insert into subscriber(subscriber_name,mobile_no,group_name,username)
 values('$subscriber_name','$mobile_no','$group_name','$username')");
}

 }// if(isset($_GET['Submit'] closing  here
...
echo "<a href='send_sms.php?username=$username' onMouseOut='MM_swapImgRestore()' onMouseOver='MM_swapImage('Image22','','images/button_web_05.jpg',1)'>"; ?><img src="images/index_06.jpg" name="Image22" width="54" height="34" border="0"></a></td>
...
<form name="msgform" id="msgform" action="add_new_subscriber.php" method="GET" onSubmit= "return validate_mobile(this);" onKeyUp="highlight(event)" onClick="highlight(event)">
<table border="0" width="100%" align="center">
<tr><td colspan="4" align="left" class="style7">Add new Subscriber>></td></tr>
<tr><td>&nbsp;</td><td align="center"><br /><br />
<table border="0" bgcolor="#f4f4f4" width="430"><tr><td>
<tr>
<td align="right"  class="style7"><br /><br /><br />
Subscriber Name*:
</td>
<td><br /><br />
<input type="text" name="subscriber_name" id="subscriber_name" size='30'>
</td>
</tr>
<tr>
...
<td>
<input type="text" name="mobile_no" id="mobile_no" size='30'>
</td>
</tr>
<tr>
<td align="right"   class="style7">
...
<tr>
<td align="right" width="42%"  class="style7">
</td>
<td>
<?php
...
<br />
<input type='submit' value='Add New Subscriber' name="Submit">
<br /><br />
</td>
</tr>
</td></tr></table>
...
<?php
if($mob_exists_in_groupname==1)
{
$subscriber_name=$_GET['subscriber_name']; //echo $subscriber_name;
$mobile_no=$_GET['mobile_no']; //echo $mobile_no;
$group_name=$_GET['group_name']; //echo $group_name;
echo "<script>alert('mobile no: $mobile_no has already registered in Group $group_name!!!Only one time registration of a mobile number is allowed in a GROUP!!.. ');</script><br />";
...
if($result==1)
{
echo "<script>alert('$subscriber_name ($mobile_no) added to Group $group_name Successfully!!');</script>";
echo "<script>document.location.href='add_new_subscriber.php?username=$username'</script>";
}
?>
</body>
