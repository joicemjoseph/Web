...
<?php 
echo "<a href='send_sms.php?username=$username' onMouseOut='MM_swapImgRestore()' onMouseOver='MM_swapImage('Image22','','images/button_web_05.jpg',1)'>"; 
?>
...
<td height="20" colspan="9" align="left" valign="top" background="images/index_19.jpg">&nbsp;</td>
	...
	<tr>
        ...
        <table width="981" height="389" border="0">
          <tr>
            <td width="40" height="127">&nbsp;</td>
            <td width="378" rowspan="3"><img src="images/sms.jpg" width="615" height="298"></td>
            <td width="501"><div align="justify"><span class="style1">Our <strong>Web SMS</strong> portal is considered the best in its class, accessible from  any internet browser it is innovative, leading edge,fully functional, user  friendly yet powerful with extended address book,and  to send SMS and much more.</span></div></td>
            <td width="34">&nbsp;</td>
          </tr>
          <tr>
            <td height="109">&nbsp;</td>
            <td><div align="justify"><span class="style1">Your virtual SMS Center.                  The simplest and easiest way to send individualized, bulk text                  messages (SMS) globally!.Our online registration process is fast and easy .</span></div></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td height="110">&nbsp;</td>
            <td><strong>How it works?</strong><br>
              <br>
              <span class="style1">From our dedicated server which work 24x7 to give you non-stop service,  the SMS you send from this website (websms.com), it goes through  our server and deliverd to your Mobile / Cellular Phones.  </span></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td height="23">&nbsp;</td>
