...
$id=$_GET['id']; //echo $id;
$mem_id=$_GET["id_edit"]; //echo $mem_id;
$mem_action=$_GET["action"];
$mem_table=$_GET["table"];


$delete=mysql_query("delete from $mem_table where id=$mem_id");
...
<script type="text/javascript" src="javascript/delete_sms.js"></script>
<style type="text/css">
a {
color:#333;
...
<td align="left" valign="top"><?php echo "<a href='create_group_login.php?username=$username' onMouseOut='MM_swapImgRestore()' onMouseOver='MM_swapImage('Image22','','images/button_web_05.jpg',1)'>"; ?><img src="images/index_06.jpg" name="Image22" width="54" height="34" border="0"></a></td>
...
<table border="0" width="100%" align="center">
<tr><td colspan="4" align="left" class="style7">Delete SMS>>
</td>
</tr>
<tr height="20">
<td>
...
<?php
 ...
 echo "<script>alert('SMS Deleted Successfully ...');</script>";
 echo "<script>document.location.href='delete_sms_admin.php?username=$username'</script>";
 }  
