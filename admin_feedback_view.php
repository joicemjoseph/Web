...
<table width="90%" height="300" border="0">
<tr><td colspan="3" class="style7" align="left">View feedback>></td></tr>
          <tr>
            <td height="300">&nbsp;</td>
            <td valign="top">
	  ...
	  $id=$_GET['id'];
	 //echo $id;
	   $cnt=mysql_query("delete from feedback where id=$id");
	  if($cnt==1)
	  {
	  $result_delete=1;
	  }
	  ...
	  ?>
			...
			&nbsp;
			  ...
			  <?php
$cnt=mysql_query("select * from feedback");

while($row=mysql_fetch_array($cnt))
	 {
       ?>

<table border="0" width="500" bgcolor="#F2F2F2" align="center" class="style7">
<tr>
...
<?php
echo "<a href='admin_feedback_view.php?id=$row[4]&value=delete&username=$username'><img src=images/delete.png border='0'></img></a>";
?>
...
echo "<script>alert('Feedback Deleted Successfully !!...');</script>";
      echo "<script>document.location.href='admin_feedback_view.php?username=$username';</script>";
}
}
else
{
