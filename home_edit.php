...
<form name="msgform" id="msgform" action="home_edit.php" method="POST">
<table border="0" width="100%" align="center">
<tr><td colspan="4" align="left" class="style7">HOME page Caption>></td></tr>
<tr height="70">
<td>
<input type="hidden" name="username" id="username" <?php echo "value=$username";?>>
</td>
</tr>
      <tr><td width="100">&nbsp;</td><td class="style7" align="center" bgcolor="#f4f4f4"><br /><br />
...
<br /><br />
            ...
            <?php
             $cnt=mysql_query("select * from home");

             $row=mysql_fetch_array($cnt);
             
           echo "<textarea name='update_home' id='update_home' cols='50' rows='5'>$row[0]</textarea>";
           ?>
              </label>
             <input type="hidden" name="id" id="id" <?php echo "value=$row[1]";?>>
            <br>
            <br>
           <label>
          <input type="submit" name="Submit" id="Submit" value="Update HOME caption"  onclick="return validate();">
          </label>
           <br /><br />
           </td><td width="100">&nbsp;</td>
           </tr>
...

{
 ...
 $result=mysql_query("update home set content='$update_home' WHERE id='$id'");
 
if($result)
{
echo "<script>alert('Updated Successfully!!!');</script>";
echo "<script>document.location.href='home_edit.php?username=$username'</script>";
}
 else
 {
 $username=$_POST['username'];
